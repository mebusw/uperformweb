...
<head>
    ...
    <meta name="description" content="Scrum认证, Scrum中文培训, CSM认证，ScrumMaster敏捷开发培训, 中文敏捷认证, 敏捷项目管理培训,CSPO培训,敏捷教练, 敏捷咨询。Scrum China Agile 优普丰是中国敏捷开发培训咨询教练领导品牌！">
    <meta name="keywords" content="Scrum认证, Scrum中文培训, CSM认证，Scrum敏捷开发培训, Scrum Master,敏捷项目管理培训,CSPO培训,敏捷教练,敏捷咨询 敏捷估算">
